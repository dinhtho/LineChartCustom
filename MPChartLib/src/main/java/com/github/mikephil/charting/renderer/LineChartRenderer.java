...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        // replace by drawHighlighted(Canvas c, Highlight[] indices,boolean isHighlightPerTapEnabled)
    }

    @Override
    public void drawHighlighted(Canvas c, Highlight[] indices,boolean isHighlightPerTapEnabled) {
        ...
        for (Highlight high : indices) {
            ...
            // draw circle for top
            drawCircleTop(c, (float) pix.x, (float) pix.y);
    ...
    private void drawCircleTop(Canvas c, float x, float y){
        Paint paint = new Paint();
        paint.setColor(Color.parseColor("#f28911"));
